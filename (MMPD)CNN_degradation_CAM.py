...
if __name__ == "__main__":
    ...
    audiolen = 6       #Cropping time for audio (second)
    mymodel = "./models/MMPD_pathological_voice"
    ...
    mydata = "./audio_data/MMPD_pathological_voice"
    ...
    for i in list_i:
        ...
        if melspec.all() != 0:
            ...
            ave = -5.939793398567712
            std = 1.1599556454006106
            ...
            plt.figure(figsize=(10.7, 5), dpi=200) #MMPD setup
            ...
            save_path = save_path + files[i].split(audio_label)[-1].replace(".wav", ".png")
